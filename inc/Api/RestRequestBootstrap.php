...
use Bromate\RestApiFirewall\Security\Routes\RoutesResolver;
use WP_Error;
use WP_REST_Request;
...
final class RestRequestBootstrap {
	...
	public static function apply_route_policy( $result, $server = null, $request = null ) {
		...
		return new WP_Error(
			...
			__( 'This route is disabled by the REST API firewall policy.', 'bromate-rest-api-firewall' ),
			array( 'status' => 403 )
		);
	}

	public static function rate_limit_request( $result, $server = null, $request = null ) {
